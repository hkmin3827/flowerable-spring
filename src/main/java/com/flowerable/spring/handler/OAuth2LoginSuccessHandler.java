package com.flowerable.spring.handler;

import com.flowerable.spring.domain.auth.constant.Provider;
import com.flowerable.spring.application.auth.userInfo.GoogleOAuth2UserInfo;
import com.flowerable.spring.application.auth.userInfo.KakaoOAuth2UserInfo;
import com.flowerable.spring.application.auth.userInfo.NaverOAuth2UserInfo;
import com.flowerable.spring.application.auth.userInfo.OAuth2UserInfo;
import com.flowerable.spring.application.auth.OAuthStateService;
